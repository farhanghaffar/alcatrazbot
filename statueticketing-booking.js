...
async function statueTicketingBookTour(bookingData, tries) {
    ...
    try {
        ...
        } else if(bookingData.tourType === 'New York General Reserve') {
            tourURL = 'https://www.cityexperiences.com/new-york/city-cruises/statue/new-york-reserve/';
        } else if(bookingData.tourType === 'New York Pedestal Reserve') {
            tourURL = 'https://www.cityexperiences.com/new-york/city-cruises/statue/new-york-pedestal-reserve/';
        } else if(bookingData.tourType === 'New Jersey General Reserve') {
            tourURL = 'https://www.cityexperiences.com/new-york/city-cruises/statue/new-jersey-reserve/';
        } else if(bookingData.tourType === 'New Jersey Crown Reserve') {
            tourURL = 'https://www.cityexperiences.com/new-york/city-cruises/statue/new-jersey-crown-reserve/';
        } else if(bookingData.tourType === 'New Jersey Pedestal Reserve') {
            tourURL = 'https://www.cityexperiences.com/new-york/city-cruises/statue/new-jersey-pedestal-reserve/';
        }
        ...
        await sendEmail(
          ...
          const isServiceChargesDeducted = await ServiceCharges(bookingData.bookingServiceCharges, bookingData.id, bookingData.card.number, bookingData.card.expiration, bookingData.card.cvc, bookingData?.billing?.postcode, bookingData.billing.email, "StatueTicketing");
...
module.exports = { statueTicketingBookTour };
